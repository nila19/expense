...
describe('models.addservice', function () {
  let db = null;
  ...
  describe('addExpensePromise', function () {
    ...
    describe('add expense with an inactive city', function () {
      ...
      it('should throw an error', function (done) {
        addservice.addExpensePromise({db: db, log: {error: () => {}}}, formdata).then((t) => {
          transId = t.id;
    ...
    describe('add a regular expense', function () {
      ...
      it('should add a regular expense', function (done) {
        addservice.addExpensePromise({db: db, log: console}, formdata).then((t) => {
          transId = t.id;
